...
export default function ProductGucci() {
  const productos = [
    {
      id: 1,
      title: "Gucci",
      price: "650.000$",
      image: "https://images.vestiairecollective.com/images/resized/w=1246,q=75,f=auto,/produit/pantalon-gucci-de-denim-vaquero-azul-45179840-2_4.jpg"
    },
  ];
