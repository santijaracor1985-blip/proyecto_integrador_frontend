...
export default function ProductCalvinKlein() {
  const productos = [
    {
      id: 1,
      title: "Gorra Calvin Klein",
      price: "220.000$",
      image: "http://calvincolombia.vtexassets.com/arquivos/ids/892831-1712-2256?v=638947732894470000&width=1712&height=2256&aspect=true"
    },
  ];
